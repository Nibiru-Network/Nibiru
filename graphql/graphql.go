...
// Package graphql provides a GraphQL interface to nbn node data.
package graphql
...
// Account represents an nbn account at a particular block.
type Account struct {
...
// Transaction represents an nbn transaction.
...
type CallData struct {
	From     *common.Address // The nbn address the call is from.
	To       *common.Address // The nbn address the call is to.
