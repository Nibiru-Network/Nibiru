...
// package web3ext contains nbn specific web3.js extensions.
package web3ext
...
web3._extend({
	...
	methods: [
        ...
        new web3._extend.Method({
			name: 'getSnapshotPofAtNumber',
			call: 'alien_getSnapshotPofAtNumber',
			params: 1
		}),
        new web3._extend.Method({
			name: 'getSnapshotPofMinerAtNumber',
			call: 'alien_getSnapshotPofMinerAtNumber',
			params: 1
		}),
        new web3._extend.Method({
			name: 'getSnapshotPofReportAtNumber',
			call: 'alien_getSnapshotPofReportAtNumber',
			params: 1
		}),
        new web3._extend.Method({
			name: 'getCoinBalAtNumber',
			call: 'alien_getCoinBalAtNumber',
			params: 1
		}),
        new web3._extend.Method({
			name: 'getCoinBalance',
			call: 'alien_getCoinBalance',
			params: 1
		}),
        new web3._extend.Method({
			name: 'getCoinBalanceAtNumber',
			call: 'alien_getCoinBalanceAtNumber',
			params: 2
		}),
        new web3._extend.Method({
