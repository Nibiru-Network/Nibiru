...
var (
	...
	MainnetGenesisHash2 = common.HexToHash("0x7822b45dc1faccb5fcbf3b4cd18db777f08debc7d5850c20f0d1f756cbcc0b3a")
...
var (
	...
	MainnetChainConfig = &ChainConfig{
		...
		Alien: &AlienConfig{
			...
			GenesisTimestamp: 1673515326,
			SelfVoteSigners: []common.UnprefixedAddress{
				common.UnprefixedAddress(common.HexToAddress("0252400ea20476d6eb14c378031942f3c7f52bab")),
				common.UnprefixedAddress(common.HexToAddress("9cabd87827dd104cff4bd25fc3e8691a8dbe83ef")),
				common.UnprefixedAddress(common.HexToAddress("b0ee427c07f7e520e7fec07238678a414cbfd310")),
				common.UnprefixedAddress(common.HexToAddress("7a579bdb91b9b668763f7d06fa1ac034ce2fc29c")),
				common.UnprefixedAddress(common.HexToAddress("930f1c4ea6b5598dbe5b604da10fe0a77c86d907")),
			},
			SideChain:   false,
			MCRPCClient: nil,
			PBFTEnable:  false,
	...
	MainnetBalanceAlloc = []BanlanceAlloc{
		BanlanceAlloc{Addr: "ea2a534cd77ce52cb19f897d8bdb5aa57dcd3143", Balance: "100000000000000000000000000"},
		BanlanceAlloc{Addr: "c3c91a5c06f0b86b0ae42a82461862c890c5a9ba", Balance: "149900000000000000000000000"},
		BanlanceAlloc{Addr: "ac5deda16ae63a0fbde985f3817a0297a49e97d5", Balance: "130000000000000000000000000"},
		BanlanceAlloc{Addr: "00f9f06bf64fc0c5507dd533459131b8dde639b1", Balance: "10000000000000000000000000"},
		BanlanceAlloc{Addr: "a572d505ccc0a49ad5ad5a131e46b14cd55a5964", Balance: "10000000000000000000000000"},
		BanlanceAlloc{Addr: "51e3008185d70d7958e338f1d59f5a8e02ad1b2a", Balance: "100000000000000000000000"},
	}
	...
	// and accepted by the nbn core developers into the Ethash consensus.
	//
	...
	// and accepted by the nbn core developers into the Clique consensus.
	//
	// This configuration is intentionally not using keyed fields to force anyone
	// adding flags to the config to also have to set these fields.
...
// CheckConfigForkOrder checks that we don't "skip" any forks, nbn isn't pluggable enough
