...
func (mc *mockCaller) CallContract(ctx context.Context, call nbn.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (mc *mockCaller) PendingCallContract(ctx context.Context, call nbn.CallMsg) ([]byte, error) {
