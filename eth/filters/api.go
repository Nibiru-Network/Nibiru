...
// information related to the nbn protocol such als blocks, transactions and logs.
...
func (api *PublicFilterAPI) Logs(ctx context.Context, crit FilterCriteria) (*rpc.Subscription, error) {
	...
	logsSub, err := api.events.SubscribeLogs(nbn.FilterQuery(crit), matchedLogs)
	if err != nil {
		return nil, err
	}
...
// Same as nbn.FilterQuery but with UnmarshalJSON() method.
type FilterCriteria nbn.FilterQuery
...
func (api *PublicFilterAPI) NewFilter(crit FilterCriteria) (rpc.ID, error) {
	...
	logsSub, err := api.events.SubscribeLogs(nbn.FilterQuery(crit), logs)
	if err != nil {
		return "", err
	}
