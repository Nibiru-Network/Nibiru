...
// Package types contains data types related to nbn consensus.
package types
...
// Header represents a block header in the nbn blockchain.
type Header struct {
...
// Block represents an entire block in the nbn blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
...
// EncodeRLP serializes b into the nbn RLP block format.
