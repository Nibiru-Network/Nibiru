...
// stateObject represents an nbn account which is being modified.
//
...
type stateObject struct {
	...
	addrHash common.Hash // hash of nbn address of the account
	data     Account
	db       *StateDB
...
// Account is the nbn consensus representation of accounts.
