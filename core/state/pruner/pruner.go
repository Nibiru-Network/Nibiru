...
pruning. Remember don't start the nbn. without deleting the clean trie cache
otherwise the entire database may be damaged!

Check the command description "nbn. snapshot prune-state --help" for more details.
`
