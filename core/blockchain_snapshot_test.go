...
// It can be used for testing that restart nbn. normally.
...
// It can be used for testing that restart nbn. after the crash.
...
// Tests a nbn. restart with valid snapshot. Before the shutdown, all snapshot
...
// Tests a nbn. was crashed and restarts with a broken snapshot. In this case the
...
// Tests a nbn. was crashed and restarts with a broken snapshot. In this case
...
// Tests a nbn. was running with snapshot enabled. Then restarts without
...
// Tests the nbn. was running with snapshot enabled and resetHead is applied.
...
// Tests the nbn. was running with a complete snapshot and then imports a few
