...
# 1. install nbn for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for nbn
# 5. create nbn, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable nbn_SOCKET
...
!define GROUPNAME "nbn"
!define APPNAME "nbn"
!define DESCRIPTION "Official Go implementation of the nbn protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since nbn is installed global
