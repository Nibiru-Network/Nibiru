Name "nbn ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/token/issues"
!define UPDATEURL "https://github.com/token/releases"
!define ABOUTURL "https://github.com/token#nbn"
...
Section "nbn" nbn_IDX
  ...
  SimpleFC::AdvRemoveRule "nbn incoming peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "nbn outgoing peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "nbn UDP discovery (UDP:30303)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "nbn incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\nbn.exe" "" "" "nbn" 30303 "" "" ""
  SimpleFC::AdvAddRule "nbn outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\nbn.exe" "" "" "nbn" "" 30303 "" ""
  SimpleFC::AdvAddRule "nbn UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\nbn.exe" "" "" "nbn" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/ethereum/EIPs/issues/147)
  ${EnvVarUpdate} $0 "nbn_SOCKET" "R" "HKLM" "\\.\pipe\nbn.ipc"
  ${EnvVarUpdate} $0 "nbn_SOCKET" "A" "HKLM" "\\.\pipe\nbn.ipc"
...
Function GetInstalledSize
  ...
  ${if} ${SectionIsSelected} ${nbn_IDX}
    SectionGetSize ${nbn_IDX} $0
