...
Please see [Releases](https://github.com/token/releases). We recommend using the [most recently released version](https://github.com/token/releases/latest).

## Audit reports

Audit reports are published in the `docs` folder: https://github.com/token/tree/master/docs/audits 

| Scope | Date | Report Link |
| ------- | ------- | ----------- |
| `nbn` | 20170425 | [pdf](https://github.com/token/blob/master/docs/audits/2017-04-25_nbn-audit_Truesec.pdf) |
| `clef` | 20180914 | [pdf](https://github.com/token/blob/master/docs/audits/2018-09-14_Clef-audit_NCC.pdf) |

## Reporting a Vulnerability

**Please do not file a public ticket** mentioning the vulnerability.

To find out how to disclose a vulnerability in nbn visit [https://bounty.nbn.org](https://bounty.nbn.org) or email bounty@nbn.org. Please read the [disclosure page](https://github.com/token/security/advisories?state=published) for more information about publically disclosed security vulnerabilities.

Use the built-in `nbn version-check` feature to check whether the software is affected by any known vulnerability. This command will fetch the latest [`vulnerabilities.json`](https://nbn.org/docs/vulnerabilities/vulnerabilities.json) file which contains known security vulnerabilities concerning `nbn`, and cross-check the data against its own version number.
