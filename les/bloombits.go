...
import (
	...
	"github.com/token/common/bitutil"
	"github.com/token/light"
)

const (
	// bloomServiceThreads is the number of goroutines used globally by an nbn
...
func (eth *Lightnbn) startBloomHandlers(sectionSize uint64) {
