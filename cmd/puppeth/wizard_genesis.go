...
// importGenesis imports a nbn genesis spec into puppeth.
...
func (w *wizard) manageGenesis() {
	...
	case "2":
		...
		// Export the native genesis spec used by puppeth and nbn
		...
		// Export the genesis spec used by Aleth (formerly C++ nbn)
		...
		// Export the genesis spec used by Harmony (formerly nbnJ)
