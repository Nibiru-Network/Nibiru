...
type wizard struct {
	...
	services map[string][]string   // nbn services known to be running on servers
...
// converts it to an nbn address. If an empty line is entered, the default
// value is returned.
