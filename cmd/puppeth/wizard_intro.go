...
// setting up a new or managing an existing nbn private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your nbn private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new nbn network down to  |")
	...
	log.Info("Administering nbn network", "name", w.network)
