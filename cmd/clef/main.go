...
import (
	...
	"github.com/token/signer/core"
	"github.com/token/signer/fourbyte"
	"github.com/token/signer/rules"
	"github.com/token/signer/storage"
...
func init() {
	app.Name = "Clef"
	app.Usage = "Manage nbn account operations"
	app.Flags = []cli.Flag{
		logLevelFlag,
		keystoreFlag,
		configdirFlag,
