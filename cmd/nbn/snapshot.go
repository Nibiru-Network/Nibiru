...
import (
	...
	"github.com/token/core/state/snapshot"
...
var (
	snapshotCommand = cli.Command{
		...
		Subcommands: []cli.Command{
			{
				Name:      "prune-state",
				Usage:     "Prune stale nbn state data based on the snapshot",
				ArgsUsage: "<root>",
				...
				Description: `
nbn snapshot prune-state <state-root>
...
during the use of nbn, please also specify it here for correct deletion. Otherwise
...
`,
			},
			{
				...
				Description: `
nbn snapshot verify-state <state-root>
...
`,
			},
			{
				...
				Description: `
nbn snapshot traverse-state <state-root>
...
`,
			},
			{
				...
				Description: `
nbn snapshot traverse-rawstate <state-root>
...
`,
			...
			{
				Name:      "dump",
				Usage:     "Dump a specific block from storage (same as 'nbn dump' but using snapshots)",
				...
				Description: `
This command is semantically equivalent to 'nbn dump', but uses the snapshots
