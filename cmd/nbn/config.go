...
// makeConfigNode loads nbn configuration and creates a blank node instance.
...
// makeFullNode loads nbn configuration and creates the nbn backend.
func makeFullNode(ctx *cli.Context) (*node.Node, ethapi.Backend) {
	...
	// Add the nbn Stats daemon if requested.
	if cfg.Ethstats.URL != "" {
