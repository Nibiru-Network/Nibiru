...
// all blocks' seal as valid, though they still have to conform to the nbn
// consensus rules.
...
// still have to conform to the nbn consensus rules.
...
// they still have to conform to the nbn consensus rules.
