...
// mapped from textual names used in the tests below to actual nbn private
...
// address retrieves the nbn address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the nbn address
