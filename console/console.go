...
import (
	...
	"github.com/token/internal/jsre"
	"github.com/token/internal/jsre/deps"
	"github.com/token/internal/web3ext"
...
type Config struct {
	...
	Client   *rpc.Client         // RPC client to execute nbn requests through
...
// Welcome show summary of current nbn instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	message := "Welcome to the nbn JavaScript console!\n\n"

	// Print some generic nbn metadata
